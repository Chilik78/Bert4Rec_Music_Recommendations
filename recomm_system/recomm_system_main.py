...
from model.modeling.support_funcs import get_shape_list, get_activation, create_initializer, layer_norm, get_assignment_map_from_checkpoint
...
# bert_config_file = 'data/steam/bert_config_steam_64.json'
# checkpoint_dir = os.path.normpath('/models/steam')
# train_input_file = 'data/steam/steam.train.tfrecord'
# test_input_file = 'data/steam/steam.train.tfrecord'
# vocab_filename = 'data/steam/steam.vocab'
...
bert_config_file = 'data/ml-1m/bert_config_ml-1m_64.json'
checkpoint_dir = os.path.normpath('/models/ml-1m')
train_input_file = 'data/ml-1m/ml-1m.train.tfrecord'
test_input_file = 'data/ml-1m/ml-1m.train.tfrecord'
vocab_filename = 'data/ml-1m/ml-1m.vocab'
