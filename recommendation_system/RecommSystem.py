from model.modeling.support_funcs import get_assignment_map_from_checkpoint, get_shape_list, get_activation, create_initializer, layer_norm
from model.modeling.BertConfig import BertConfig
from model.modeling.BertModel import BertModel
from recomm_system.EvalHooks import EvalHooks
...
class RecommSystem:
    ...
    def __init__(self, 
        ...
        self.__bert_config_file = bert_config_file # Файл конфигурации гиперпараметров модели
        self.__checkpoint_dir = os.path.normpath(os.getcwd() + checkpoint_dir) # Файл для сохранения прогресса при тренировке модели
        self.__train_input_file = train_input_file # Файл с тренировочными данными
        self.__test_input_file = test_input_file # Файл с тестовыми данными
        self.__vocab_filename = vocab_filename # Файл словаря
        self.__predict_input_file = predict_input_file # Файл с историей пользователя, для прогнозирования
